...
export const CardPreviewItem = ({ cardItem }) => {
    const assets = {
        // cardImage: getFromPublic('/assets/images/dino-1.png'),
        iconPlay: getFromPublic('/assets/images/card-icons/Play.svg'),
        iconPause: getFromPublic('/assets/images/card-icons/Pause.png'),
    }

    return (
        <div className="flex flex-col items-center justify-center max-w-[219px] min-h-[263px] pt-[26px] pb-[16px] px-[40px] backdrop-blur-xl border-[2px] border-white-0.2 rounded-[32px] text-white-0.6">
